...
<body>
    ...
    <form action="ejercicio9.php" method="post" enctype="multipart/form-data">
        ...
        <div>
            ...
            <input type='text' id="titulo" name="titulo" value="<?php if (isset($_POST['titulo'])) {
                                                                    echo $_POST['titulo'];
                                                                } ?>" />
            ...
            <input type='text' id="director" name="director" value="<?php if (isset($_POST['director'])) {
                                                                        echo $_POST['director'];
                                                                    } ?>" />
            ...
            <input type='text' id="produccion" name="produccion" value="<?php if (isset($_POST['produccion'])) {
            ...
            <input type='text' id="nacionalidad" name="nacionalidad" value="<?php if (isset($_POST['nacionalidad'])) {
            ...
            <input type='number' id="duracion" name="duracion" value="<?php if (isset($_POST['duracion'])) {
                                                                            echo $_POST['duracion'];
                                                                        } ?>" />
        ...
        <div>
            ...
            <input type='text' id="actores" name="actores" value="<?php if (isset($_POST['actores'])) {
                                                                        echo $_POST['actores'];
                                                                    } ?>" />
            ...
            <input type='text' id="guion" name="guion" value="<?php if (isset($_POST['guion'])) {
                                                                    echo $_POST['guion'];
                                                                } ?>" />
            ...
            <input type='number' id="ano" name="ano" value="<?php if (isset($_POST['ano'])) {
                                                                echo $_POST['ano'];
                                                            } ?>" />
            ...
            <select name="genero" id="gen">
                ...
                <option value='accion' <?php comprobarChecked('accion') ?>>Acción</option>
            ...
            <div id="radio">
                <input type="radio" name="restricciones" id="todos" value="todos" <?php
                                                                                    if (isset($_POST['restricciones']) && $_POST['restricciones'] == "todos") {
                                                                                        echo "checked";
                                                                                    }
                                                                                    ?> />
                <label for="todos">Todos los públicos</label>
                <input type="radio" name="restricciones" id="mayores7" value="mayor7" <?php
                ...
                <input type="radio" name="restricciones" id="mayores18" value="mayor18" <?php
