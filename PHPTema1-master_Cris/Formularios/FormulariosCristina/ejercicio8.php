...
<body>
    ...
    <form action="ejercicio8.php" method="post">
        ...
        <input type='text' id="edad" name="edad" placeholder="introduzca la edad..." value="<?php if (isset($_POST['edad'])) {
                                                                                                echo $_POST['edad'];
                                                                                            } ?>" />
        ...
        <input type="radio" name="estudiante" value="0" id="est" <?php
                                                                    if (!isset($_POST['btnEnviar']) || $_POST['estudiante'] == "0") {
                                                                        echo "checked";
                                                                    }
                                                                    ?> />
        <label for="est">Soy estudiante</label>

        <input type="radio" name="estudiante" value="1" id="noest" <?php
